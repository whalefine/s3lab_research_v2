...
def local_env_settings():
    ...
    settings.network_path = '/home/chanyuan/02_RESEARCH/s3lab_research_v2/python/output_vit/test/networks'    # Where tracking networks are stored.
    ...
    settings.result_plot_path = '/home/chanyuan/02_RESEARCH/s3lab_research_v2/python/output_vit/test/result_plots'
    settings.results_path = '/home/chanyuan/02_RESEARCH/s3lab_research_v2/python/output_vit/test/tracking_results'    # Where to store tracking results
    settings.save_dir = '/home/chanyuan/02_RESEARCH/s3lab_research_v2/python/output_vit'
    settings.segmentation_path = '/home/chanyuan/02_RESEARCH/s3lab_research_v2/python/output_vit/test/segmentation_results'

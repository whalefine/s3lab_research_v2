...
可由 ViT-Tiny (192 維) checkpoint 做左上角截斷載入（邏輯同 vit_CARE_relu6_dim32）。
結構與 vit_CARE_relu6.VisionTransformer 一致。
"""
...
def load_vit_tiny_pretrained_dim32(model: VisionTransformer, checkpoint_path: str) -> Tuple[list, list]:
    ...
    print(f"[vit_CARE_relu6_shared_trunk_dim32] Loaded projected pretrained from: {checkpoint_path}")

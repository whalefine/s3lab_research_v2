...
# SRAM macros use CLK(~clk); add generated clock in APR if signoff requires it:
# create_generated_clock -name clk_sram -source [get_ports clk] -divide_by 1 -invert [get_pins .../CLK]

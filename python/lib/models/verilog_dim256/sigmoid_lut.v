...
// -----------------------------------------------------------------------------
// numpy: sigmoid_clamped() in run_backbone_numpy_dim256_q88.py
...
wire signed [DATA_W-1:0] in_clip_w ;

assign in_clip_w = (in_q88 >  16'sd2048) ? 16'sd2048 :
                   (in_q88 < -16'sd2048) ? -16'sd2048 : in_q88 ;

// LUT case + linear interp + clamp (combinational, same as original)
always @(*) begin
    shifted = in_clip_w[12:0] + 13'd2048 ;
    idx6    = shifted[12] ? 6'd63 : shifted[11:6] ;
    frac6   = shifted[5:0] ;

...
// Preload Sram_tok1: one write per posedge (SRAM CLK=clk, write sampled at posedge;
// addr/din valid for the full cycle via NBA, so each idx is stored exactly once)

...
// All SRAM macros use CLK(clk) (posedge, registered-data: addr@T -> Q@T+1). head_top /
// cal_bbox drive A/CEB/WEB/D combinationally to keep the read latency at 1 cycle.
//
//   Sram_v    -> x_buf
//   Sram_q/k  -> sh1 lo/hi
//   Sram_tok2 -> sh2

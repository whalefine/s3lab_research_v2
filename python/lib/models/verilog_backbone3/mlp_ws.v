...
reg        fc2_sram_rd_en_r;
reg [6:0]  fc2_sram_rd_feat_r;
...
wire        fc2_sram_rd_fire = fc2_sram_rd_en_r ||
    (state == S_BLOAD && layer == 1'b1 &&
     bl_cnt == 4'd7 && bl_phase == 1'b1);
wire [6:0]  fc2_sram_rd_feat_mux =
    (state == S_BLOAD && layer == 1'b1 &&
     bl_cnt == 4'd7 && bl_phase == 1'b1) ? 7'd0 :
    fc2_sram_rd_feat_r;

...
//
//   vcs verilog_backbone3/sglatrack_top.v verilog_backbone3/test/TEST_backbone.v memory/*.v \
//     <path>/Sram_tok1.v <path>/Sram_tok2.v \
//     <path>/Sram_q.v <path>/Sram_k.v <path>/Sram_v.v <path>/Sram_qkm.v \
//     +incdir+verilog_backbone3 +lint=TFIPC-L +define+TSMC_CM_NO_WARNING | tee runvcs.log
//
//   ./simv | tee simv.log
//

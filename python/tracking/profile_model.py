...
def parse_args():
    ...
    parser.add_argument('--config', type=str, default='deit_distilled', help='yaml configure file name')
...
if __name__ == "__main__":
    ...
    if args.script == "sglatrack":
        model_module = importlib.import_module('lib.models')
        model_constructor = model_module.build_sglatrack
